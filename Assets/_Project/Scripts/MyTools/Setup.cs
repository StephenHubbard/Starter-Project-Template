...
public static class Setup
{
    ...
    public static void ImportMyFavoriteAssets()
    {
        ...
        Assets.ImportAsset("Asset Inventory.unitypackage", "Impossible Robert/Editor ExtensionsUtilities");
    }
    ...
    static class Assets
    {
        public static void ImportAsset(string asset, string subfolder, string folder = "C:/Users/Owner/AppData/Roaming/Unity/Asset Store-5.x")
        {
